export const timeChecker = (orderType, currentTime) => {
    switch (orderType) {
        ...
        case "pre_order":
            ...
            const todayPreOrder = nowPreOrder.toLocaleDateString("en-US", {
                weekday: "long",
            });

            // Create an array of 365 days starting from tomorrow
            const daysPreOrder = [];
            ...
            for (let i = 0; i < 365; i++) {
                const dateStr = fullDateFormatter.format(nowPreOrder);
                daysPreOrder.push(dateStr);
